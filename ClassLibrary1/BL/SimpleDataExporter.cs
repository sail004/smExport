...
{
    public class SimpleDataExporter : BaseDataExporter
    {
        protected override ExportDescriptor SaveExcelFile(List<ProductGroup> readProductGroups, List<Product> readProducts, string exportDir)
        {
